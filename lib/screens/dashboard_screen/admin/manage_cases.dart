...
class CaseApiService {
  ...
  static Future<void> deleteCase(int caseId) async {
    ...
    if (response.statusCode != 200) {
      throw Exception(
        'Failed to delete case: ${response.body}',
      );
    }
  }
...
class ManageCasesPage extends StatefulWidget {
  ...
  @override
  State<ManageCasesPage> createState() =>
      _ManageCasesPageState();
}

class _ManageCasesPageState
    extends State<ManageCasesPage> {
  ...
  Future<void> _loadCases() async {
    ...
    try {
      ...
      final cases =
          await CaseApiService.fetchAllCases();
  ...
  Future<void> _deleteCase(CaseModel c) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to delete case #${c.id}?',
        ),
  ...
  Future<void> _updateStatus(
    ...
    try {
      ...
      await CaseApiService.updateCaseStatus(
        c.id,
        newStatus,
      );
